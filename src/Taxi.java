public class Taxi extends Car {
  ...
  public void chargeAndDropOffRiders(double fareperRider)
  {
int riders = getPassengers() - 1;
double totalfare  = getPassengers() * fareperRider;
fareCollected += totalfare;

    boolean dropOffSuccessful = super.dropOffPassengers(riders);
